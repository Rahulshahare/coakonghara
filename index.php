...
<html lang="en">
  <head>
    ...
    <title>Collage Of Agriculture Konghara</title>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#" title="Collage Of Agriculture Konghara">COAKONGHARA</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">its Menu <span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
  ...
  <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
    ...
    <div class="container-fluid nextStep stats">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <h1>Oceangreen Technology</h1>
                <h3>We work for excellence</h3>
                </span><br/>
                <div class="row">
                        <div class="col-md-4 post">
                            <img src="./images/val.jpg" width="100%"/>
                            <br/><br/>
    ...
    <script type="text/javascript">
        $('.carousel').carousel('cycle',function() {
            interval: 100
            })
    </script>
  </body>
